...
public class ModFoodComponents {
    ...
    public static final FoodComponent shit = new FoodComponent.Builder()
            ...
            .build();
    public static final FoodComponent bad_lemonTea = new FoodComponent.Builder()
            .hunger(1).saturationModifier(0.5f).meat().alwaysEdible()
            .statusEffect(new StatusEffectInstance(StatusEffects.SPEED,114), 1.0f).build();
        }